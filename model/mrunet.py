...
class MultiResUnet(torch.nn.Module):
    ...
    def __init__(self, input_channels, num_classes, alpha=1.67):
        ...
        self.in_filters1 = int(32*self.alpha*0.167) + \
            int(32*self.alpha*0.333)+int(32*self.alpha * 0.5)
        ...
        self.in_filters2 = int(32*2*self.alpha*0.167) + \
            int(32*2*self.alpha*0.333)+int(32*2*self.alpha * 0.5)
        ...
        self.in_filters3 = int(32*4*self.alpha*0.167) + \
            int(32*4*self.alpha*0.333)+int(32*4*self.alpha * 0.5)
        ...
        self.in_filters4 = int(32*8*self.alpha*0.167) + \
            int(32*8*self.alpha*0.333)+int(32*8*self.alpha * 0.5)
        ...
        self.in_filters5 = int(32*16*self.alpha*0.167) + \
            int(32*16*self.alpha*0.333)+int(32*16*self.alpha * 0.5)
        ...
        self.conv_final = Cv2d_BN(
            self.in_filters9, num_classes+1, kernel_size=(1, 1), activation='None')
